...
- **Базовая система памяти**: Включает базовую систему извлечения и вызова памяти. Автоматически извлекает ключевые факты из разговоров для долговременного хранения (SQLite), поддерживая восстановление контекста в реальном времени и сохранение эмоций на основе семантического поиска (RAG).
