...
Посетите [страницу Releases](https://github.com/chyinan/Kokoro-Engine/releases), чтобы загрузить последнюю предварительно собранную версию. Просто распакуйте и запустите.
